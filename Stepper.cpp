...
Stepper::Stepper(int number_of_steps, int motor_pin_1, int motor_pin_2)
{
  ...
  gpio_init(this->motor_pin_1);
  gpio_set_dir(this->motor_pin_1, GPIO_OUT);
  gpio_init(this->motor_pin_2);
  gpio_set_dir(this->motor_pin_2, GPIO_OUT);
                                      ...
                                      int motor_pin_3, int motor_pin_4)
{
  ...
  gpio_init(this->motor_pin_2);
  gpio_set_dir(this->motor_pin_2, GPIO_OUT);
  gpio_init(this->motor_pin_3);
  gpio_set_dir(this->motor_pin_3, GPIO_OUT);
  gpio_init(this->motor_pin_4);
  gpio_set_dir(this->motor_pin_4, GPIO_OUT);
                                      ...
                                      int motor_pin_5)
{
  ...
  gpio_init(this->motor_pin_4);
  gpio_set_dir(this->motor_pin_4, GPIO_OUT);
  gpio_init(this->motor_pin_5);
  gpio_set_dir(this->motor_pin_5, GPIO_OUT);
...
void Stepper::step(int steps_to_move)
{
  ...
  while (steps_left > 0)
  {
    unsigned long now = to_us_since_boot(get_absolute_time());
